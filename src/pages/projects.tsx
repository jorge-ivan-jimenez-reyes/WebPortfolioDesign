...
// Componente para cada proyecto individual para manejar hooks correctamente
const ProjectItem: React.FC<{ project: Project; index: number; getCategoryIcon: (category: string) => string; totalProjects?: number }> = ({ project, index, getCategoryIcon, totalProjects = 0 }) => {
  ...
  return (
    <div className="group relative cursor-pointer transition-all duration-500 hover:scale-[1.02]">
      ...
      {index < totalProjects - 1 && (
        <div 
          className="h-px mx-6 transition-all duration-500 mt-6"

...
const Footer = () => {
    return (
        <footer id="footer" className="c-lesPJm c-lesPJm-iBYZKI-css">
            <div aria-hidden="true" className="c-lesPJm c-lesPJm-ijodOwq-css"></div>
            <div className="c-lesPJm c-lesPJm-iezzKVe-css">
                <a
                    className="c-gasElL"
                    aria-label="Home"
                ...
                >
                    <div aria-hidden="true" style={{ display: "contents" }}>
                        <div className="c-lesPJm c-lesPJm-igHjMGo-css"></div>
                        ...
                        <div className="c-lesPJm c-lesPJm-ieQQNgx-css" style={{ opacity: 1 }}></div>
                    </div>
                </a>
                ...
                <hr className="c-lesPJm c-lesPJm-igIauhs-css" />
                ...
                >
                    <div aria-hidden="true" style={{ display: "contents" }}>
                        ...
                        <svg aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path
                                opacity="0.25"
                                d="M1 6C1 4.34315 2.34315 3 4 3H20C21.6569 3 23 4.34315 23 6V18C23 19.6569 21 21 20 21H4C2.34315 21 1 19.6569 1 18V6Z"
                                fill="currentColor"
                            />
                            <path
                                fillRule="evenodd"
                    ...
                    <div aria-hidden="true" style={{ display: "contents" }}>
                        ...
                        >
                            <mask id="myMask2">
                                ...
                                <circle r="9" fill="black" cx="50%" cy="23%" />
                            </mask>
                            <circle cx="12" cy="12" fill="var(--colors-gray10)" mask="url(#myMask2)" r="9" />
                ...
                <button
                    className="c-gasElL c-gasElL-ibxSAEs-css"
                    data-state="tooltip-hidden"
                    data-reach-tooltip-trigger=""
                    style={{ width: "40px", height: "40px", top: "0px" }}

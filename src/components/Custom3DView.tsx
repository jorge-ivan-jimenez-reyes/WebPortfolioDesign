...
// Define your custom colors with opacity
const colors = [
...
const Cell: React.FC = memo(() => {
    // Use a subtle translucent white for a glass-like effect
    const [bg, setBg] = useState('rgba(255,255,255,0.2)');
    ...
    return (
        <div
            className="w-full h-full border border-white/30 backdrop-blur-sm rounded-md transition-all duration-300"
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    // A large square container that fills most of the viewport
                    width: '450vmin',
                    height: '450vmin',
                    display: 'grid',
